...
if __name__ == "__main__":
    ...
    price_scenario_len= sum([pd.read_excel(_,"Default - External Data").fillna(0).shape[0] for _ in tec_scenarios])
    j=0
    for t_sc in tec_scenarios:
        ...
        print("Calculation Scenario: "+ scenario_name+"...")
        for p_sc in range(pd.read_excel(t_sc,"Default - External Data").fillna(0).shape[0]): 
            j=j+1
            ...
            if solutions == "Error1":
                ...
                if output == "Error4":
                    ...
                    filename = scenario_name+"_"+str(p_sc)+".html" 
                    ...
                    # -- Download JSON 
                    filename = scenario_name+"_"+str(p_sc)+".json"
                    path_download = os.path.join(create_folder(scenario_name),filename)
