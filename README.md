...
* [Read the documentation online (recommended)](https://tuw-eeg.github.io/hotmapsDispatch/)
...
Licensed under the GNU GENERAL PUBLIC LICENSE (the "LICENSE"); you may not use this file except in compliance with the License. 
